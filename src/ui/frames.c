                           ...
                           MetaFrameBorders *borders)
{
  ...
  /* Scale borders to ensure proper frame position */
  ...
  if (window_has_shape)
    {
      ...
      shape_window = XCreateWindow (display, RootWindow (display, screen_number),
                                    -5000, -5000,
                                    new_window_width,
                                    new_window_height,
                                    0,
                ...
                MetaUIFrame *frame)
{
  ...
  /* right */
  pixels->piece[2].rect.x = borders.total.left / scale + width;
  ...
  pixels->piece[3].rect.y = borders.total.top / scale + height;
  pixels->piece[3].rect.width = width + borders.total.left * scale + borders.total.right * scale;
